...
import com.ureca.snac.wallet.service.OptimisticWalletFacade;
...
class WalletLockComparisonIntegrationTest extends IntegrationTestSupport {
    ...
    void setUp() {
        ...
        OptimisticWalletFacade.resetCounters();
    }
    ...
    private void printResult(int successA, int successB, int successC, int failCount,
        ...
        System.out.printf("재시도 횟수 (낙관락)            : %d%n", OptimisticWalletFacade.RETRY_COUNT.get());
